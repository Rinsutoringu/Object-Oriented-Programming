...
public class Teacher {
    ...
    public int grading(Student s) {
        ...
        // if the student has not submitted the assignment, return 0
        if (a == null) {
            return 0;
        }
        // if the student has submitted the assignment, but overtime, return 0
        if (!a.isSubmitted()) {
            return 0;
        }
        // if the student has submitted the assignment, but the code cannot compile, return 0
        Code c = a.getCode();
        if (!c.compile()) {
            return 0;
        }
        // if the student has submitted the assignment, but the code cannot run, return 50
        if (!c.run()) {
            return 50;
        }
        // if the student has submitted the assignment, but the code lines <100, return 80
        if (c.countLines() < 100) {
            return 80;
        }
        // if the student has submitted the assignment, but the code lines >100, return 100
        return 100;
    }
